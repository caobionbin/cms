...
public class MenuController {
	...
	public ModelAndView getMenus(HttpServletRequest request) {
		...
		if (nowpage == null || "".equals(nowpage)) {
			...
			mv.addObject("menus", menuService.getMenusByPage((Integer.valueOf(nowpage) - 1) * pageCount + 1,
					(Integer.valueOf(nowpage)) * pageCount + 1));
			// List<Menus> list =
			// menuService.getMenusByPage((Integer.valueOf(nowpage)-1)*pageCount+1,(Integer.valueOf(nowpage))*pageCount+1);
	...
	public ModelAndView updateMenu(HttpServletRequest request, HttpServletResponse response, Menus menus)
			throws Exception {
		ModelAndView mv = new ModelAndView("/menu/menu");
	...
	public ModelAndView addMenu(HttpServletRequest request, HttpServletResponse response, Menus menus)
			throws Exception {
