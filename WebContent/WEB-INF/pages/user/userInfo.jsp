				...
				<div class="container-fluid">
					<div class="row-fluid">
							...
							<div id="myTabContent" class="tab-content">
									...
									<div class="col-md-8">
										<form id="tab" action="/webtest/userBean/updateUserBean" class="form-horizontal" method="post">
								...
								<div id="passwordedit" class="tab-pane fade">
									<form id="tab2" action="/webtest/userBean/updateUserBean" method="post" class="form-horizontal">
