							...
							<form action="#" method="post"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" id="personNumid" name="personNum"
											class="form-control" readonly="readonly" value="${order.personNum }" />
									</div>
								</div>
								<div class="form-group">
									<!-- 下拉列表 -->
									...
									<div class="col-sm-10">
										<select id="tableIdid" name="tableId" class="form-control" disabled="disabled">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select multiple="multiple" id="menusid" name="menuIds"
											...
											<c:forEach items="${order.orderDetails }" var="menu">
								...
								<div class="form-group">
									...
									<div
										...
										<input type="text" id="orderTimeid" name="orderTime"
											class="form-control" size="16" readonly="readonly" value="${order.orderTime }" disabled="disabled"/> <span
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" id="remarkId" name="remark"
											class="form-control" value="${order.remark }" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input id="idpayid" type="text" name="idpay"
											class="form-control" value="${order.idpay }" readonly="readonly"/>
								...
								<div class=" col-md-12">
									<div class="col-md-offset-4">
										<a href="/webtest/orders/getOrders"> <span
