			...
			<div class="content col-md-10 ">
				...
				<div class="container-fluid">
					<div class="row-fluid">
						<!-- well嵌入的效果 -->
						<div class="col-md-12">
							<form action="/webtest/menus/addMenu" method="post" class="form-horizontal" enctype="multipart/form-data">
								<div class="row-fluid">
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<select id="menutype" name="mtid" class="form-control" multiple="multiple">
									...
									<%-- <div class="col-md-5">
											<div class="thumbnail" style="width:220px;height:170px">
												...
												<img alt="yyy" src="/webtest/images/${menu.imgName }">
											</div>
