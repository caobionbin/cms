...
<script type="text/javascript">
	function getimageload() {
		$("#getimage").attr("src", "/webtest/validate/getimage?Math.random();");
	}
</script>
...
<body id="divback">
	<div>
		...
		<div class="container" style="margin-top: 200px">
			<form class="form-signin" action="/webtest/login/getLoginUser"
				method="post">
				...
				<input type="text" class="input-block-level" placeholder="用户名"
					...
					placeholder="密码" name="passWord" /> <input type="text"
					id="validatecss" name="validate" placeholder="验证码">&nbsp;&nbsp;&nbsp;&nbsp;
				<img id="getimage" alt="yyy" src="/webtest/validate/getimage"
					onclick="this.src='/webtest/validate/getimage?'+Math.random();"
					class="img-rounded">
				<p id="validate"></p>
